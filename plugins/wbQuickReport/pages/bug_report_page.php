...
# along with MantisBT.  If not, see <http://www.gnu.org/licenses/>.
  ...
  if ( $f_master_bug_id > 0 ) {
    ...
    if ( ( ALL_PROJECTS == helper_get_current_project() ) ) {
      print_header_redirect( 'login_select_proj_page.php?ref=' . base64_encode('plugin.php?page=wbQuickReport/') );
    }
  ...
  # don't index bug report page  html_robots_noindex();
...
?>
<br />
<div align="center" style="float:left;width:49%;position:relative;">
  <form name="report_bug_form" target="bugReportFrame" method="post"
    <?php if ( $tpl_show_attachments ) { echo 'enctype="multipart/form-data"'; } ?>
    action="plugin.php?page=wbQuickReport/bug_report"
    onsubmit="this.action='plugin.php?page=wbQuickReport/bug_report&r='+(Math.random()*99999);return true;"
    >
...
<div align="center" style="float:right;width:49%;">
  <iframe src="plugin.php?page=wbQuickReport/bug_report" id="bugReportFrame" name="bugReportFrame" style="width:100%;height:120px;" onload="doMyRefresh();"></iframe>
  <iframe src="plugin.php?page=wbQuickReport/changelog_page" id="changeLogFrame" name="changeLogFrame" style="width:100%;height:640px;"></iframe>
</div>
...
<!--
  ...
  function doMyRefresh(){
    document.getElementById('changeLogFrame').src = 'plugin.php?page=wbQuickReport/changelog_page&r='+(Math.random()*9999);
    document.getElementById('bugReportFrame').className += ' refreshed';
    setTimeout(function(){
      document.getElementById('bugReportFrame').className = String(document.getElementById('bugReportFrame').className).replace(/ refreshed/,'');
    }, 2000);
  }
-->
</script>
...
?>
<style>
div#bodycol { width:auto; }
div#bodycol form,
div#bodycol form input[type=text],
div#bodycol form textarea {
  width: 100%;
  max-width: 100%;
}
div#bodycol form table {
  width: 100%;
}
div#bodycol iframe {
